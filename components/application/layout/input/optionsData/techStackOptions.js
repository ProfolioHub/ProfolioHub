...
import { BilogooPostgresql, BilogooFlask, BilogooCPlusPlus } from "react-icons/bi";
...
export const TechStackOptions = [
    ...
    {
        name: "PostgreSQL",
        icon: <BilogooPostgresql className="md:text-4xl text-2xl" color="#376695" />
    },
    {
        name: "Flask",
        icon: <BilogooFlask className="md:text-4xl text-2xl text-black dark:text-white" />
    },
    {
        name: "Python",
    ...
    {
        name: "C",
        icon: <BilogooCPlusPlus className="md:text-4xl text-2xl" color="#3f4fae" />
    },
    {
        name: "C++",
        icon: <BilogooCPlusPlus className="md:text-4xl text-2xl" color="#3f4fae" />
