...
export default function Home() {
  ...
  return (
    <Fragment>
      {/* Head */}
      <Head>
        <title>ProfolioHub Personal Portfolio Generator</title>
        <meta content="ProfolioHub Personal Portfolio Generator" name="title" />
        <meta content="ProfolioHub is the best personal portfolio generator that allows anyone to effortlessly create their own impressive portfolio website." name="description" />
        ...
        <meta content="Tim Cook" name="author" />
